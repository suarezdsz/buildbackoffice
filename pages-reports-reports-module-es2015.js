...
/* harmony import */ var _reports_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./reports.component */ "qzPY");
...
/* harmony import */ var _reports_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./reports.component */ "qzPY");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_reports_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./reports.component.html */ "SByP");
/* harmony import */ var _reports_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./reports.component.scss */ "Sbq6");
...
let ReportsComponent = class ReportsComponent {
    ...
    onSubmit() {
        this.userService.getUsers(this.form.value).subscribe((res) => {
            console.log(res);
            this.data = res.data;
        });
    }
    listRefered(refered) {
        this.userService.getUsersRefered(refered).subscribe((res) => {
            console.log(res);
            this.data = res.data;
        });
    }
